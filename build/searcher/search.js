...
const expiryTimeMilliseconds = 0;
...
function noResults() {
	document.getElementById("search-result").innerHTML = "<p class='results-count'>No results found.</p>";
}

function displayLoading() {
	document.getElementById("search-result").innerHTML = "<p class='loading'>Loading search index, please wait&hellip;</p>";
}
